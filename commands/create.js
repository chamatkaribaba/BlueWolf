module.exports.help = {
    name: "create",
    decreption: "to start a giveaway with requirements",
    aliases: []
}
        ...
        collector4.on("collect", async collect4 => {
          ...
          collector5.on("collect", async collect5 => {
            ...
            if (response5.toLowerCase() !== "none") {
              ...
              return message.channel.send(`**Please use the command \`\`${prefix}gaw\`\` instead to make a giveaway without a server requirement**`)
            }
          });
        });
      });
